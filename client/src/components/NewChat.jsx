...
export default function NewChat({ closeConfirmation }) {
              ...
              <Dialog.Panel className='relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full p-4'>
                <div className='flex-col'>
                  ...
                  <div className='mt-2 flex-col space-y-3'>
                    <div className=''>
                      ...
                      {!loading && !error && data.users.length > 0 ? (
                        <select
                          ...
                          } w-full py-1 px-3 font-semibold shadow-sm text-custom-dark-blue sm:text-sm rounded-sm`}
                          onChange={(event) => {
                    ...
                    {recipient !== "" && (
                      <PostMessage
                        activeSecondPerson={recipient}
                        closePopup={false}
                        closeConfirmation={closePopup}
                      />
                    )}
                  </div>
                </div>
